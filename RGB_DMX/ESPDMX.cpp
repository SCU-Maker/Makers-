...
void DMXESPSerial::update() {
  ...
  Serial1.begin(BREAKSPEED, BREAKFORMAT);//Serial1.begin(250000,  SERIAL_8N2);
  Serial1.write(0);
  Serial1.flush();
  delay(1);
  Serial1.end();
  ...
  //send data
  Serial1.begin(DMXSPEED, DMXFORMAT);//Serial1.begin(250000,  SERIAL_8N2);
  digitalWrite(sendPin, LOW);
  Serial1.write(dmxData, chanSize);//Serial1.write(dmxData, 32);
  Serial1.flush();
  delay(1);
  Serial1.end();
}
