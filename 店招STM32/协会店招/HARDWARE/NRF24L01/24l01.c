...
{ 	
  ...
  SPI_InitTypeDef  SPI_InitStructure;
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_7|GPIO_Pin_8|GPIO_Pin_11;	//PG8 7 推挽 	  
	...
	GPIO_ResetBits(GPIOA,GPIO_Pin_11|GPIO_Pin_7|GPIO_Pin_8);//PG6,7,8上拉	
    GPIO_ResetBits(GPIOB,GPIO_Pin_12);//PG6,7,8上拉			    
...
u8 NRF24L01_Check(void)
{
	...
	u8 i;
	SPI2_SetSpeed(SPI_BaudRatePrescaler_2); //spi速度为9Mhz（24L01的最大SPI时钟为10Mhz）   	 
