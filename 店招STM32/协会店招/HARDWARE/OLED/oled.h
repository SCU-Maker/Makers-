...
#define OLED_RST_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_9)//RES
#define OLED_RST_Set() GPIO_SetBits(GPIOB,GPIO_Pin_9)
...
//////#define OLED_RST_Clr() GPIO_ResetBits(GPIOC,GPIO_Pin_14)//RES
//////#define OLED_RST_Set() GPIO_SetBits(GPIOC,GPIO_Pin_14)
...
//////#define OLED_SCLK_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_7)//CLK
